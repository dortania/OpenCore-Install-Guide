...
For those needing macOS versions no longer hosted on Apple's catalog (i.e. Sierra and older), follow the [Legacy macOS install](https://github.com/dortania/OpenCore-Install-Guide/blob/master/installer-guide/legacy-mac-install.md) guide
...
## Now with all of this done, head to [Setting up the EFI](../installer-guide/opencore-efi.md) to finish up your work
