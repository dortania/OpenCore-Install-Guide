...
* **DEBUG**: Can greatly help with debugging boot issues, however can add some noticeable delay to boot times (i.e. 3-5 seconds to get to the picker). Once installed you can easily transition to RELEASE.
...
Now you can place **your** necessary firmware drivers (.efi) into the Drivers folder and Kexts/ACPI into their respective folders. See [Gathering Files](../ktext.md) for more info on which files you should be using.
