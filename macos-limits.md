...
* **Samsung PM981, PM991 and Micron 2200S NVMe SSDs**
  ...
  * Note that the Intel® Optane™ Memory H10 with Solid State Storage is compatible if the Intel® Optane™ Memory H10 is blocked in SSDT. Read this [article](https://zhuanlan.zhihu.com/p/429073173) (Chinese) for more details. English version is available [here](https://blog.csdn.net/weixin_46341175/article/details/126626808).
