...
* [HfsPlus.efi](https://github.com/acidanthera/OcBinaryData/blob/master/Drivers/HfsPlus.efi)(<span style="color:red">Optional</span>)
  * Needed for seeing HFS volumes(ie. macOS Installers and Recovery partitions/images). You can use if it's necessary **Do not mix other HFS drivers**
