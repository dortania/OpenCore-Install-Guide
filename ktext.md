...
* [RealtekRTL8111](https://github.com/Mieze/RTL8111_driver_for_OS_X/releases)
  ...
  * Requires OS X 10.8 (v2.2.0 and below), 10.12-13 (v2.2.2), 10.14 (2.4.0)
  * **NOTE:** Sometimes Realtek's Gigabit Ethernet may not work correctly with the latest version of the kext. If you see this issue, try older versions.
