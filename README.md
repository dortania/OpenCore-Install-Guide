...
* OpenCore offers better overall security with better support for FileVault, no need to disable System Integrity Protection\(SIP\) and even secure boot-like functionality support via [Vaulting](post-install/post-install/security.md#Vault)
...
* CFG Lock \(MSR 0xE2 write protection\)
  * If this can't be turned off in the BIOS\(or even found\) please consider patching it out. See [Fixing CFG Lock](post-install/post-install/msr-lock.md) for more info.
