...
* [Disabling CFG Lock](msr-lock.md#disabling-cfg-lock)
* [Checking if CFG-Lock can be turned off](msr-lock.md#checking-if-cfg-lock-can-be-turned-off)
* [Turning off CFG-Lock manually](msr-lock.md#turning-off-cfg-lock-manaully)
