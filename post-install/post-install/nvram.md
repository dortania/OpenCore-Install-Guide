...
* [Cleaning out the Clover gunk](nvram.md#cleaning-out-the-clover-gunk)
* [Verifying if you have working NVRAM](nvram.md#verifying-if-you-have-working-nvram)
* [Enabling emulated NVRAM \(with a nvram.plist\)](nvram.md#enabling-emulated-nvram-with-a-nvramplist)
...
For B360, B365, H310, H370, Z390 users, make sure you have [SSDT-PMC](https://github.com/acidanthera/OpenCorePkg/blob/master/Docs/AcpiSamples/SSDT-PMC.dsl) both under EFI/OC/ACPI and config.plist -&gt; ACPI -&gt; Add. For more info on making and compiling SSDTs, please see [**Getting started with ACPI**](../../acpi.md)
...
![](../../.gitbook/assets/nvram%20%281%29.png)
