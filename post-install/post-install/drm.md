...
* [Testing Hardware Acceleration and Decoding](drm.md#testng-hardware-acceleration-and-decoding)
* [Testing DRM](drm.md#testing-drm)
* [Fixing DRM](drm.md#fixing-drm)
* [Fixing iGPU performance](drm.md#fixing-igpu-performance)
...
![Example of shikigva in Devices Properties](../../.gitbook/assets/dgpu-path.png)
...
* **And** a recent chipset, 300-series or newer: Z390, B360, H370, H310, etc. \(_**not**_ Z370, as it is actually 200-series\)
...
![Example of igfxfw injected into iGPU](../../.gitbook/assets/igpu-path.png)
...
![](../../.gitbook/assets/igpu-frequency.png)
