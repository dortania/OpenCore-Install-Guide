...
* [Finding your layout ID](audio.md#fixing-your-layout-id)
* [Testing your layout](audio.md#testing-your-layout)
* [Making Layout ID more permanent](audio.md#making-layout-id-more-permanent)
* [Miscellaneous issues](audio.md#miscellaneous-issues)
* [Troubleshooting](audio.md#troubleshooting)
  * [Checking if you have the right kexts](audio.md#checking-if-you-have-the-right-kexts)
  * [Checking if AppleALC is patching correctly](audio.md#checking-if-applealc-is-patching-correctly)
  * [Checking AppleHDA is vanilla](audio.md#checking-applehda-is-vanilla)
...
If you're having issues, see the [Troubleshooting section](audio.md#Troubleshooting)
...
![](../../.gitbook/assets/config-layout-id.png)
...
![](../../.gitbook/assets/hex-convert.png)
...
| :---: | :---: |
| ![](../../.gitbook/assets/right-layout.png) | ![](../../.gitbook/assets/wrong-layout.png) |
