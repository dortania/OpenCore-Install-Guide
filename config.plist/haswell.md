...
| AllowNvramReset | YES | |
| AllowSetDefault | YES | |
| Bootprotect | Disabled | WARNING: Bootprotect being left on "Bootstrap" has been known to cause Z87/Z97 motherboards to be bricked and required to be reflashed! |
| ScanPolicy | 0 | |
