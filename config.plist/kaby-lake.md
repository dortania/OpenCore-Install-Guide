...
* **ResetHwSig**: Needed for hardware that fails to maintain hardware signature across the reboots and cause issues with waking from hibernation
...
![Misc](https://i.imgur.com/tc9IRKW.png)
