...
* **ResetHwSig**: Needed for hardware that fail to maintain hardware signature across the reboots and cause issues with waking from hibernation
...
* **UIScale**:
  * 01: 1080P
  * 02: 2160P\(Enables HIDPI, generally required for FileVault to function correctly\)
