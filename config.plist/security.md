...
macOS 13 Sonoma changed how system updates work. From now on, when you update (or install) macOS, SecureBootModel must be set to `Disabled`, otherwise it'll bootloop. Remember to change it back to another value listed down here when you finish updating macOS, as it can lead to a security breach.
