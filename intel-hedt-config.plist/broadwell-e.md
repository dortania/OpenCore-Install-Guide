...
* [Starting Point](broadwell-e.md#starting-point)
* [ACPI](broadwell-e.md#acpi)
* [Booter](broadwell-e.md#booter)
* [DeviceProperties](broadwell-e.md#deviceproperties)
* [Kernel](broadwell-e.md#kernel)
* [Misc](broadwell-e.md#misc)
* [NVRAM](broadwell-e.md#nvram)
* [SMBIOS](broadwell-e.md#platforminfo)
* [UEFI](broadwell-e.md#uefi)
* [Cleaning up](broadwell-e.md#cleaning-up)
* [Intel BIOS settings](broadwell-e.md#intel-bios-settings)
...
![ACPI](../.gitbook/assets/aptio-iv-acpi.png)
...
![Booter](../.gitbook/assets/aptio-iv-booter-hedt.png)
...
* **DisableVariableWrite**: YES
  * Needed for systems with non-functioning NVRAM, you can verify [here](../post-install/post-install/nvram.md) if yours works. For X99 we'll assume NVRAM doesn't work but post install you can double check
...
![Kernel](../.gitbook/assets/kernel%20%286%29.png)
...
![NVRAM](../.gitbook/assets/nvram%20%285%29.png)
