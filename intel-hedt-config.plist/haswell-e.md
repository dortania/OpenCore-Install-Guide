...
* [Starting Point](haswell-e.md#starting-point)
* [ACPI](haswell-e.md#acpi)
* [Booter](haswell-e.md#booter)
* [DeviceProperties](haswell-e.md#deviceproperties)
* [Kernel](haswell-e.md#kernel)
* [Misc](haswell-e.md#misc)
* [NVRAM](haswell-e.md#nvram)
* [SMBIOS](haswell-e.md#platforminfo)
* [UEFI](haswell-e.md#uefi)
* [Cleaning up](haswell-e.md#cleaning-up)
* [Intel BIOS settings](haswell-e.md#intel-bios-settings)
...
![Kernel](../.gitbook/assets/kernel%20%283%29.png)
