...
* [OpenCore booting issues](/extras/troubleshooting-cleanup.md#OpenCore-booting)
   * This is anytime before or during the loading of the macOS kernel
* [macOS booting issues](/extras/troubleshooting-cleanup.md#macOS-booting)
   * Anytime between the kernel loading and installing macOS
* [macOS post-install issues](/extras/troubleshooting-cleanup.md#macOS-post-install)
   * Anytime after macOS is installed
* [Other issues](/extras/troubleshooting-cleanup.md#other-issues)
