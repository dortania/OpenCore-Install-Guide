...
* For AMD's 15h and 16h CPUs, you may need to add the following:
  * [XLNCUSBFix.kext](https://github.com/dortania/Getting-Started-With-ACPI/blob/master/extra-files/XLNCUSBFix.kext.zip)

* If XLNCUSBFix still doesn't work, then try the following alongside XLNCUSBFix:
  * [AMD StopSign-fixv5](https://github.com/dortania/Getting-Started-With-ACPI/blob/master/extra-files/StopSign-fixv5.zip)
