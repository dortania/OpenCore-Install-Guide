...
* [Fixing CFG Lock](https://dortanian.github.io/OpenCore-Desktop-Guide/post-install/msr-lock) 
...
See [Fixing KASLR slide values](https://dortanian.github.io/OpenCore-Desktop-Guide/extras/kaslr-fix)
...
* **Missing EC patch**: 
   ...
   * If you don't have one, grab it here: [Getting started with ACPI](https://dortanian.github.io/Getting-Started-With-ACPI/)
   * Laptop users will need to rename their main EC: [Getting started with ACPI](https://dortanian.github.io/Getting-Started-With-ACPI/)
