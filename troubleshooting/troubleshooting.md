...
* [OpenCore booting issues](troubleshooting.md#opencore-booting)
  * This is anytime before or during the loading of the macOS kernel
    ...
    * [Stuck on EndRandomSeed](troubleshooting.md#stuck-on-endrandomseed)
    ...
    * [Stuck on `OC: OcAppleGenericInput... - Success`](troubleshooting.md#stuck-on-oc-ocapplegenericinput---success)
    * [Stuck on `OCB: OcScanForBootEntries failure - Not Found`](troubleshooting.md#stuck-on-ocb-ocscanforbootentries-failure---not-found)
    * [Stuck on `OCB: failed to match a default boot option`](troubleshooting.md#stuck-on-ocb-failed-to-match-a-default-boot-option)
    * [Stuck on `OCABC: Memory pool allocation failure - Not Found`](troubleshooting.md#stuck-on-ocabc-memory-pool-allocation-failure---not-found)
    * [Stuck on `OCS: No schema for DSDT, KernelAndKextPatch, RtVariable, SMBIOS, SystemParameters...`](troubleshooting.md#stuck-on-ocs-no-schema-for-dsdt-kernelandkextpatch-rtvariable-smbios-systemparameters)
    * [Stuck on `OC: Driver XXX.efi at 0 cannot be found`](troubleshooting.md#stuck-on-oc-driver-xxxefi-at-0-cannot-be-found)
    * [Stuck on `Buffer Too Small`](troubleshooting.md#stuck-on-buffer-too-small)
    * [Stuck on `Plist only kext has CFBundleExecutable key`](troubleshooting.md#stuck-on-plist-only-kext-has-cfbundleexecutable-key)
    * [Receiving `Failed to parse real field of type 1`](troubleshooting.md#receiving-failed-to-parse-real-field-of-type-1)
    * [Stuck after selection macOS partition on OpenCore](troubleshooting.md#stuck-after-selection-macos-partition-on-opencore)
    * [Can't select anything in the picker](troubleshooting.md#cant-select-anything-in-the-picker)
    * [Stuck on `This version of Mac OS X is not supported: Reason Mac...`](troubleshooting.md#stuck-on-this-version-of-mac-os-x-is-not-supported-reason-mac)
    * [`Couldn't allocate runtime area` errors?](troubleshooting.md#couldnt-allocate-runtime-area-errors)
    * [SSDTs not being added](troubleshooting.md#ssdts-not-being-added)
    * [Booting OpenCore reboots to BIOS](troubleshooting.md#booting-opencore-reboots-to-bios)
    * [OCABC: Incompatible OpenRuntime r4, require r10](troubleshooting.md#ocabc-incompatible-openruntime-r4-require-r10)
* [macOS booting issues](troubleshooting.md#macos-booting)
  * Anytime between the kernel loading and installing macOS
    * [Stuck on `RTC...`, `PCI ConfigurationBegins`, `Previous Shutdown...`, `HPET`, `HID: Legacy...`](troubleshooting.md#stuck-on-rtc-pci-configuration-begins-previous-shutdown-hpet-hid-legacy)
    * ["Waiting for Root Device" or Prohibited Sign error](troubleshooting.md#waiting-for-root-device-or-prohibited-sign-error)
    * [macOS installer in Russian](troubleshooting.md#macos-installer-in-russian)
    * [macOS Installer being damaged](troubleshooting.md#macos-installer-being-damaged)
    * [Stuck on or near `IOConsoleUsers: gIOScreenLock...`](troubleshooting.md#stuck-on-or-near-ioconsoleusers-gioscreenlockgiolockstate-3)
    * [Scrambled Screen on laptops](troubleshooting.md#scrambled-screen-on-laptops)
    ...
    * [300 series Intel stalling on `apfs_module_start...`](troubleshooting.md#300-series-intel-stalling-on-apfsmodulestart)
    * [Kernel Panic `Cannot perform kext summary`](troubleshooting.md#kernel-panic-cannot-perform-kext-summary)
    * [Kernel Panic `AppleIntelMCEReporter`](troubleshooting.md#kernel-panic-appleintelmcereporter)
    * [Kernel Panic `AppleIntelCPUPowerManagement`](troubleshooting.md#kernel-panic-appleintelcpupowermanagement)
    * [Frozen in the macOS installer after 30 seconds](troubleshooting.md#frozen-in-the-macos-installer-after-30-seconds)
    * [15h/16h CPU reboot after Data & Privacy screen](troubleshooting.md#15h16h-cpu-reboot-after-data--privacy-screen)
    * [Keyboard works but trackpad does not](troubleshooting.md#keyboard-works-but-trackpad-does-not)
    * [Sleep crashing on AMD](troubleshooting.md#sleep-crashing-on-amd)
    ...
    * [MediaKit reports not enough space](troubleshooting.md#mediakit-reports-not-enough-space)
* [macOS post-install issues](troubleshooting.md#macos-post-install)
  * Anytime after macOS is installed
    * [Broken iMessage and Siri](troubleshooting.md#broken-imessage-and-siri)
    * [No on-board audio](troubleshooting.md#no-on-board-audio)
    * [BIOS reset or sent into Safemode after reboot/shutdown?](troubleshooting.md#bios-reset-or-sent-into-safemode-after-rebootshutdown)
    * [macOS GPU acceleration missing on AMD X570](troubleshooting.md#macos-gpu-acceleration-missing-on-amd-x570)
    * [DRM Broken](troubleshooting.md#drm-broken)
    * ["Memory Modules Misconfigured" on MacPro7,1](troubleshooting.md#memory-modules-misconfigured-on-macpro71)
    * [Apps crashing on AMD](troubleshooting.md#apps-crashing-on-amd)
* [Other issues](troubleshooting.md#other-issues)
  * This includes troubleshooting tools used for making your USB, fixing cosmetics in OpenCore, etc
    * [Can't run `acpidump.efi`](troubleshooting.md#cant-run-acpidumpefi)
    * [Fixing SSDTTime: `Could not locate or download iasl!`](troubleshooting.md#fixing-ssdttime-could-not-locate-or-download-iasl)
    * [Fix Python: `Python is not installed or not found on PATH`](troubleshooting.md#fix-python-python-is-not-installed-or-not-found-on-path)
    * [Windows Startup Disk can't see APFS drives](troubleshooting.md#windows-startup-disk-cant-see-apfs-drives)
    * [Incorrect resolution with OpenCore](troubleshooting.md#incorrect-resolution-with-opencore)
    * [No temperature/fan sensor output](troubleshooting.md#no-temperaturefan-sensor-output)
    * [Can't find Windows/Bootcamp drive in picker](troubleshooting.md#cant-find-windowsbootcamp-drive-in-picker)
    * ["You can't change the startup disk to the selected disk" error](troubleshooting.md#you-cant-change-the-startup-disk-to-the-selected-disk-error)
    * [Booting Windows results in Bluescreen or Linux crashes](troubleshooting.md#booting-windows-results-in-bluescreen-or-linux-crashes)
    * [Booting Windows error: `OCB: StartImage failed - Already started`](troubleshooting.md#booting-windows-error-ocb-startimage-failed---already-started)
...
**Note**: Vault and FileVault are 2 separate things, see [Security and FileVault](../post-install/post-install/security.md) for more details
...
* CFG-Lock not off\(Intel Users only\), couple solutions:
  * [Patch your MSR E2](../post-install/post-install/msr-lock.md)\(Recommended solution\)
...
![Directory Structure from OpenCore&apos;s DOC](../.gitbook/assets/oc-structure.png)
...
* **NVRAM Failing**:
  * Common issue HEDT and 300 series motherboards, you have a couple paths to go down:
    ...
    * HEDT: See [Emulating NVRAM](../post-install/post-install/nvram.md) on how to stop NVRAM write, note that for install you do not need to run the script. Just setup the config.plist
* **RTC Missing**:
...
![Scrambled Screen](https://github.com/dortania/OpenCore-Desktop-Guide/tree/1df9c33baf2de31c48092f0c768ce798459af99e/images/troubleshooting/troubleshooting-md/Scrambled.jpg) Enable CSM in your UEFI settings. This may appear as "Boot legacy ROMs" or other legacy setting.
...
Commonly due to systems running AWAC clocks, pleas see the [Getting started with ACPI](../acpi.md) section
...
![](../.gitbook/assets/asus-tsc.jpg)

### Keyboard works but trackpad does not

Make sure that VoodooInput is listed _before_ VoodooPS2 and VoodooI2C kexts in your config.plist.

#### VoodooI2C Troubleshooting

Check the order that your kexts load - make they match what is shown under [Gathering Files](https://github.com/dortania/OpenCore-Desktop-Guide/tree/1df9c33baf2de31c48092f0c768ce798459af99e/OpenCore/ktext.md):
...
| :---: | :---: |
| ![](../.gitbook/assets/default.png) | ![](../.gitbook/assets/showalldevices.png) |
...
![](../.gitbook/assets/en0-built-in.png)

If these fixes do not work, see the [Fixing iServices page](../post-install/post-install/iservices.md) for more in-depth guide.

### No on-board audio

Refer to [Fixing Audio with AppleALC](../post-install/post-install/audio.md) section
...
| Enabled | Boolean | YES |
| Count | Number | 1 |
| Base | String | \_\_ZN8AppleRTC14updateChecksumEv |
...
See [Fixing DRM](../post-install/post-install/drm.md) page
...
* [Booting Windows error: `OCB: StartImage failed - Already started`](troubleshooting.md#booting-windows-error-ocb-startimage-failed---already-started)
* [iASL warning, \# unresolved](troubleshooting.md#iasl-warning--unresolved)
* [No Volume/Brightness control on external monitors](troubleshooting.md#no-volumebrightness-control-on-external-monitors)
...
![](../.gitbook/assets/python-path.png)
...
* Follow [Hiding Verbose](https://github.com/dortania/OpenCore-Desktop-Guide/tree/1df9c33baf2de31c48092f0c768ce798459af99e/troubleshooting/verbose.md) for correct setup, set `UIScale` to `02` for HiDPI
...
* [FakeSMC3\_with\_plugins](https://github.com/CloverHackyColor/FakeSMC3_with_plugins/releases)
...
This is due to OpenCore getting confused when trying to boot boot Windows and accidentally thinking it's booting OpenCore. This can be avoided by either move Windows to it's own drive _or_ adding a custom drive path under BlessOverride. See [Configuration.pdf](https://github.com/acidanthera/OpenCorePkg/blob/master/Docs/Configuration.pdf) for more details.
