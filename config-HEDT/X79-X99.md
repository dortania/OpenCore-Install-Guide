# Ivy Bridge to Broadwell-E(Don't follow, likely this guide won't be released)
...
* **DisableVariableWrite**: NO
   * Needed for systems with non-functioning NVRAM, this is common on X79 and X99. You can verify [here](/post-install/nvram.md) if yours works
...
* [Testing and setting emulated NVRAM](/post-install/nvram.md)
