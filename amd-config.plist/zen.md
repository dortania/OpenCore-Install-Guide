...
* [Starting Point](zen.md#starting-point)
* [ACPI](zen.md#acpi)
* [Booter](zen.md#booter)
* [DeviceProperties](zen.md#deviceproperties)
* [Kernel](zen.md#kernel)
* [Misc](zen.md#misc)
* [NVRAM](zen.md#nvram)
* [SMBIOS](zen.md#platforminfo)
* [UEFI](zen.md#uefi)
* [Cleaning up](zen.md#cleaning-up)
* [AMD BIOS settings](zen.md#amd-bios-settings)
...
![ACPI](../.gitbook/assets/acpi%20%281%29.png)

**Add:**

This is where you'll add SSDTs for your system, these are very important to **booting macOS** and have many uses like [USB maps](https://usb-map.gitbook.io/project/), [disabling unsupported GPUs](https://github.com/dortania/OpenCore-Desktop-Guide/tree/eb65e8891b0534a231cf2f39e55dd34c6e32ea05/post-install/spoof.md) and such. And with our system, **its even required to boot**. Guide on making them found here: [**Getting started with ACPI**](../acpi.md)
...
![Booter](../.gitbook/assets/aptio-v-booter.png)
...
![DeviceProperties](../.gitbook/assets/dp-no-igpu.png)
...
![Kernel](../.gitbook/assets/kernel.png) ![](../.gitbook/assets/kernel-patch.png)
...
![](../.gitbook/assets/kernel.gif)

**Quirks**: Settings relating to the kernel, for us we'll be enabling `DummyPowerManagement`, `PanicNoKextDump`, `PowerTimeoutKernelPanic` and `XhciPortLimit`. Everything else should be left as default
...
![PlatformInfo](../.gitbook/assets/imacpro-smbios.png)
...
![UEFI](../.gitbook/assets/aptio-v-uefi.png)
